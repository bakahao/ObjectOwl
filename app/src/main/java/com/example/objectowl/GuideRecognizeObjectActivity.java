...
public class GuideRecognizeObjectActivity extends AppCompatActivity {

    TextView descriptionTextView, descriptionTextView2;
    ImageButton returnButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guide_recognize_object);

        // Find the TextViews and Button by their IDs
        descriptionTextView = findViewById(R.id.description);
        descriptionTextView2 = findViewById(R.id.description2); // Second TextView
        returnButton = findViewById(R.id.returnButton);

        // Call the method to read from Excel and set the description text
        String description1 = readDescriptionFromExcel(this, 1); // Read first description
        String description2 = readDescriptionFromExcel(this, 2); // Read second description

        descriptionTextView.setText(description1);  // Set first description
        descriptionTextView2.setText(description2); // Set second description
        ...
        returnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(GuideRecognizeObjectActivity.this, UserGuidePageActivity.class);
