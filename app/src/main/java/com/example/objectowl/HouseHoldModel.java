...
public class HouseHoldModel {
    ...
    private static void displayConfidences(Context context, String recognizedAnimal, TextView confidence) {
        try {
            ...
            InputStream fis = assetManager.open("houseHold_des.xlsx");
            ...
            for (Row row : sheet) {
                String objectName = row.getCell(0).getStringCellValue(); // Assuming animal names are in the first column
                ...
                if (objectName.equalsIgnoreCase(recognizedAnimal)) {
